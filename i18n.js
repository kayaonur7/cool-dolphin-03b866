...
(function () {
  ...
  var translations = {
    en: {
      ...
      // ── PRIVACY: Alışveriş Listesi AI ──
      privacy_h_alisveris: 'Alışveriş Listesi AI Mobile Application',
      privacy_alisveris_intro: 'The Alışveriş Listesi AI mobile application ("the App") is developed by Northern Rock Technology Consulting LLC. This section describes how the App handles user data.',
      privacy_alisveris_h_collect: 'Data We Collect',
      privacy_alisveris_collect_1: '<strong>Account Information:</strong> When you create an account, we collect your name, email address, and a unique user identifier for authentication and profile display purposes.',
      privacy_alisveris_collect_2: '<strong>Shopping List Data:</strong> Your shopping lists, items, categories, and related content are stored in Google Firebase Firestore to enable cloud sync and list sharing features.',
      privacy_alisveris_collect_3: '<strong>Voice Data:</strong> When you use the voice input feature, audio is processed on-device using Apple\'s Speech Recognition framework. Voice data is not transmitted to our servers.',
      privacy_alisveris_h_use: 'How We Use Your Data',
      privacy_alisveris_use_1: 'Authenticate your identity and maintain your account',
      privacy_alisveris_use_2: 'Store and sync your shopping lists across devices',
      privacy_alisveris_use_3: 'Enable list sharing and collaboration with other users',
      privacy_alisveris_use_4: 'Provide automatic product categorization (processed on-device)',
      privacy_alisveris_h_sharing: 'Data Sharing',
      privacy_alisveris_sharing: 'We do not sell or share your personal data with third parties for advertising or marketing purposes. Your data is shared only with:',
      privacy_alisveris_sharing_1: '<strong>Google Firebase:</strong> Used for authentication, data storage, and real-time sync. Subject to Google\'s Privacy Policy.',
      privacy_alisveris_sharing_2: '<strong>Shared List Members:</strong> When you share a list, other members can see the list contents and your display name.',
      privacy_alisveris_h_retention: 'Data Retention & Deletion',
      privacy_alisveris_retention: 'Your data is retained as long as your account is active. You can delete your account and all associated data at any time from the Profile screen within the App. Account deletion is permanent and cannot be undone.',
      privacy_alisveris_h_children: 'Children\'s Privacy',
      privacy_alisveris_children: 'The App is not directed to children under 13. We do not knowingly collect personal information from children under 13.',
      privacy_alisveris_h_contact: 'Contact',
      privacy_alisveris_contact: 'For Alışveriş Listesi AI privacy questions, email info@northernrocktech.com.',
    ...
    tr: {
      ...
      // ── PRIVACY: Alışveriş Listesi AI ──
      privacy_h_alisveris: 'Alışveriş Listesi AI Mobil Uygulaması',
      privacy_alisveris_intro: 'Alışveriş Listesi AI mobil uygulaması ("Uygulama") Northern Rock Technology Consulting LLC tarafından geliştirilmiştir. Bu bölüm, Uygulamanın kullanıcı verilerini nasıl işlediğini açıklar.',
      privacy_alisveris_h_collect: 'Topladığımız Veriler',
      privacy_alisveris_collect_1: '<strong>Hesap Bilgileri:</strong> Hesap oluşturduğunuzda, kimlik doğrulama ve profil görüntüleme amacıyla adınızı, e-posta adresinizi ve benzersiz bir kullanıcı tanımlayıcısını toplarız.',
      privacy_alisveris_collect_2: '<strong>Alışveriş Listesi Verileri:</strong> Alışveriş listeleriniz, ürünleriniz, kategorileriniz ve ilgili içerikleriniz, bulut senkronizasyonu ve liste paylaşım özelliklerini sağlamak için Google Firebase Firestore\'da saklanır.',
      privacy_alisveris_collect_3: '<strong>Ses Verileri:</strong> Sesli giriş özelliğini kullandığınızda, ses Apple\'ın Konuşma Tanıma çerçevesi kullanılarak cihaz üzerinde işlenir. Ses verileri sunucularımıza iletilmez.',
      privacy_alisveris_h_use: 'Verilerinizi Nasıl Kullanıyoruz',
      privacy_alisveris_use_1: 'Kimliğinizi doğrulamak ve hesabınızı yönetmek',
      privacy_alisveris_use_2: 'Alışveriş listelerinizi cihazlar arasında saklamak ve senkronize etmek',
      privacy_alisveris_use_3: 'Diğer kullanıcılarla liste paylaşımı ve işbirliğini sağlamak',
      privacy_alisveris_use_4: 'Otomatik ürün kategorizasyonu sağlamak (cihaz üzerinde işlenir)',
      privacy_alisveris_h_sharing: 'Veri Paylaşımı',
      privacy_alisveris_sharing: 'Kişisel verilerinizi reklam veya pazarlama amacıyla üçüncü taraflarla satmaz veya paylaşmayız. Verileriniz yalnızca aşağıdakilerle paylaşılır:',
      privacy_alisveris_sharing_1: '<strong>Google Firebase:</strong> Kimlik doğrulama, veri depolama ve gerçek zamanlı senkronizasyon için kullanılır. Google\'ın Gizlilik Politikasına tabidir.',
      privacy_alisveris_sharing_2: '<strong>Paylaşılan Liste Üyeleri:</strong> Bir listeyi paylaştığınızda, diğer üyeler liste içeriğini ve görünen adınızı görebilir.',
      privacy_alisveris_h_retention: 'Veri Saklama ve Silme',
      privacy_alisveris_retention: 'Verileriniz hesabınız aktif olduğu sürece saklanır. Hesabınızı ve ilişkili tüm verileri istediğiniz zaman Uygulama içindeki Profil ekranından silebilirsiniz. Hesap silme işlemi kalıcıdır ve geri alınamaz.',
      privacy_alisveris_h_children: 'Çocukların Gizliliği',
      privacy_alisveris_children: 'Uygulama 13 yaşın altındaki çocuklara yönelik değildir. 13 yaşın altındaki çocuklardan bilerek kişisel bilgi toplamayız.',
      privacy_alisveris_h_contact: 'İletişim',
      privacy_alisveris_contact: 'Alışveriş Listesi AI gizlilik soruları için info@northernrocktech.com adresine e-posta gönderin.',
